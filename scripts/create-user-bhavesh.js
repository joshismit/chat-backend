/**
 * Create User Script for Prisma/PostgreSQL
 * Creates a user with phone: 8690111115, name: Bhavesh, password: test123
 * 
 * Usage: node scripts/create-user-bhavesh.js
 */
